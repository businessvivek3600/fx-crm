...
//   // } catch (e) {
//   //   pl(e);
//   //   logger.e('upgrader.initialize()', error: e, tag: 'checkForUpdate');
//   // }
// }
//
// /// update android app
...
//   var info = await PackageManager.getPackageInfo();
//   pl('package info : ${info.toJson()}', 'getPackageInfo');
...
//             custom_tabs.ViewControllerModalPresentationStyle.formSheet,
...
// }
//
// URLType checkURLType(String? url) {
//   if (url == null || url.isEmpty) {
//     return URLType.none;
//   } else if (url.startsWith('file://')) {
//     return URLType.file;
//     // } else if (url.startsWith('memory://')) {
//     //   return URLType.memory;
